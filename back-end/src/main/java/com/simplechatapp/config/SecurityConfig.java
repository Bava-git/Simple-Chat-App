package com.simplechatapp.config;


import com.simplechatapp.jwt.JwtAuthenticationFilter;
import com.simplechatapp.service.CustomUserDetails;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/**", "/api/messages/**").permitAll()
